    ...
    <PopoverPrimitive.Portal container={portal.portalContainerRef} keepMounted>
      ...
      <PopoverPrimitive.Positioner {...positioner} class="isolate z-50">
        <PopoverPrimitive.Popup
          ...
          {...rest}
        >
          <PopoverPrimitive.Arrow class="data-[side=bottom]:top-[-7px] data-[side=left]:right-[-12px] data-[side=left]:rotate-90 data-[side=right]:left-[-12px] data-[side=right]:-rotate-90 data-[side=top]:bottom-[-7px] data-[side=top]:rotate-180">
            <ArrowSvg />
