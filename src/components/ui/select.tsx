...
function SelectGroup(props: SelectPrimitive.Group.Props) {
  ...
  return <SelectPrimitive.Group data-slot="select-group" class={cn('scroll-my-1 p-1', local.class)} {...rest} />
}

function SelectValue(props: SelectPrimitive.Value.Props) {
  const [local, rest] = splitProps(props, ['class'])
  return <SelectPrimitive.Value data-slot="select-value" class={cn('flex flex-1 text-left', local.class)} {...rest} />
}
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          <SelectPrimitive.List>{local.children}</SelectPrimitive.List>
...
function SelectSeparator(props: SelectPrimitive.Separator.Props) {
  ...
  return (
    <SelectPrimitive.Separator
      ...
      class={cn('pointer-events-none -mx-1 my-1 h-px bg-border/50', local.class)}
      {...rest}
    />
  )
}
